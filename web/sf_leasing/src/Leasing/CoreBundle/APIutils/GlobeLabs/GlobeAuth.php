...
class GlobeAuth extends GlobeClient
{
    ...
    {
        return sprintf(GlobeAuth::LOGIN_URL, GlobeClient::AUTH_POINT).'?app_id='.$this->api_key;
    }
    ...
    public function getAccessToken($code, $sms = false, $bodyOnly = true)
    {
        ...
        $url = sprintf(GlobeAuth::AUTH_URL, GlobeClient::AUTH_POINT);
