...
use Leasing\CoreBundle\APIutils\GlobeLabs\GlobeSms;
use Leasing\CoreBundle\APIutils\GlobeLabs\GlobeAuth;
use Leasing\CoreBundle\APIutils\GlobeLabs\GlobePayment;
...
class GlobeClient
{
    ...
    public function sms($shortCode, $version = null)
    {
        ...
        return new GlobeSms($this->shortCode, $ver);
    }
     ...
     * @return Payment
     */
    public function payment($accessToken = null, $endUserId = null, $version = null)
    {
        //check if the user passed a version parameter and use if any
        $ver = $version ? $version : $this->version;

        return new GlobePayment(
            $ver,
            $endUserId,
            $accessToken
        );
    ...
    protected function _curlPost($url, $fields = array()) {
        ...
        //$header = $temp[0] ? $temp[0] : null;
        //$body = $temp[1] ? $temp[1] : null;
