...
namespace Leasing\CoreBundle\APIutils\GlobeLabs;

class GlobeSms extends GlobeClient
{
	//PUBLIC VARIABLES
    public $version;
    public $recepient;
     ...
     */
    public function __construct($address = null, $version = null)
    {
    ...
    {
        $url = sprintf(self::RESC_URL, GlobeClient::API_ENDPOINT, $this->version, $this->address);
     ...
     * @return array
     */
    public function sendMessage($number = null, $message = null, $appId, $appSecret, $bodyOnly = true)
    {
        /*if ($accesstoken) {
        ...
        $postFields = array(
            ...
            'passphrase' => 'vHp1inm9iw'
        );*/
        $url = 'https://devapi.globelabs.com.ph/smsmessaging/v1/outbound/7158/requests?app_id='.$appId.'&app_secret='.$appSecret.'';
        $postFields = array(
            'message' => $this->message,
            'address' => $this->recepient,
            'senderAddress' => $this->address,
