...
abstract class BaseLeasingCalendar extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Leasing\\CoreBundle\\Model\\LeasingCalendarPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        LeasingCalendarPeer
     */
    ...
    /**
     * The value for the calendar_post_id field.
     * @var        int
     */
    protected $calendar_post_id;
    ...
    /**
     * Get the [calendar_post_id] column value.
     *
     * @return int
     */
    public function getCalendarPostId()
    {

        return $this->calendar_post_id;
    }
     ...
     * @return LeasingCalendar The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = LeasingCalendarPeer::ID;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = LeasingCalendarPeer::NAME;
        }
    ...
    /**
     * Set the value of [calendar_post_id] column.
     *
     * @param  int $v new value
     * @return LeasingCalendar The current object (for fluent API support)
     */
    public function setCalendarPostId($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->calendar_post_id !== $v) {
            $this->calendar_post_id = $v;
            $this->modifiedColumns[] = LeasingCalendarPeer::CALENDAR_POST_ID;
        }
    ...
    public function setAvailability($v)
    {
        ...
        if ($this->availability !== $v) {
            $this->availability = $v;
            $this->modifiedColumns[] = LeasingCalendarPeer::AVAILABILITY;
        }
    ...
    public function setStartDate($v)
    {
        ...
        if ($this->start_date !== $v) {
            $this->start_date = $v;
            $this->modifiedColumns[] = LeasingCalendarPeer::START_DATE;
        }
    ...
    public function setEndDate($v)
    {
        ...
        if ($this->end_date !== $v) {
            $this->end_date = $v;
            $this->modifiedColumns[] = LeasingCalendarPeer::END_DATE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->calendar_post_id = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
            $this->availability = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            ...
            return $startcol + 6; // 6 = LeasingCalendarPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating LeasingCalendar object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = LeasingCalendarPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = LeasingCalendarQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                LeasingCalendarPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(LeasingCalendarPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(LeasingCalendarPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(LeasingCalendarPeer::CALENDAR_POST_ID)) {
            $modifiedColumns[':p' . $index++]  = '`calendar_post_id`';
        }
        if ($this->isColumnModified(LeasingCalendarPeer::AVAILABILITY)) {
            $modifiedColumns[':p' . $index++]  = '`availability`';
        }
        if ($this->isColumnModified(LeasingCalendarPeer::START_DATE)) {
            $modifiedColumns[':p' . $index++]  = '`start_date`';
        }
        if ($this->isColumnModified(LeasingCalendarPeer::END_DATE)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`name`':
                        ...
                        break;
                    case '`calendar_post_id`':
                        $stmt->bindValue($identifier, $this->calendar_post_id, PDO::PARAM_INT);
                        break;
                    case '`availability`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = LeasingCalendarPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = LeasingCalendarPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['LeasingCalendar'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['LeasingCalendar'][$this->getPrimaryKey()] = true;
        $keys = LeasingCalendarPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
            $keys[2] => $this->getCalendarPostId(),
            $keys[3] => $this->getAvailability(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setCalendarPostId($arr[$keys[2]]);
        if (array_key_exists($keys[3], $arr)) $this->setAvailability($arr[$keys[3]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LeasingCalendarPeer::ID)) $criteria->add(LeasingCalendarPeer::ID, $this->id);
        if ($this->isColumnModified(LeasingCalendarPeer::NAME)) $criteria->add(LeasingCalendarPeer::NAME, $this->name);
        if ($this->isColumnModified(LeasingCalendarPeer::CALENDAR_POST_ID)) $criteria->add(LeasingCalendarPeer::CALENDAR_POST_ID, $this->calendar_post_id);
        if ($this->isColumnModified(LeasingCalendarPeer::AVAILABILITY)) $criteria->add(LeasingCalendarPeer::AVAILABILITY, $this->availability);
        if ($this->isColumnModified(LeasingCalendarPeer::START_DATE)) $criteria->add(LeasingCalendarPeer::START_DATE, $this->start_date);
        if ($this->isColumnModified(LeasingCalendarPeer::END_DATE)) $criteria->add(LeasingCalendarPeer::END_DATE, $this->end_date);
    ...
    {
        $criteria = new Criteria(LeasingCalendarPeer::DATABASE_NAME);
        $criteria->add(LeasingCalendarPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of LeasingCalendar (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setCalendarPostId($this->getCalendarPostId());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return LeasingCalendar Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return LeasingCalendarPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new LeasingCalendarPeer();
        }
     ...
     * If this LeasingCalendar is new, it will return
    ...
    public function setLeasingUnitCalendars(PropelCollection $leasingUnitCalendars, PropelPDO $con = null)
    {
        ...
        foreach ($leasingUnitCalendarsToDelete as $leasingUnitCalendarRemoved) {
            $leasingUnitCalendarRemoved->setLeasingCalendar(null);
        }
    ...
    protected function doAddLeasingUnitCalendar($leasingUnitCalendar)
    {
        ...
        $leasingUnitCalendar->setLeasingCalendar($this);
    }
    ...
    public function removeLeasingUnitCalendar($leasingUnitCalendar)
    {
        if ($this->getLeasingUnitCalendars()->contains($leasingUnitCalendar)) {
            ...
            $leasingUnitCalendar->setLeasingCalendar(null);
        }
     ...
     * Otherwise if this LeasingCalendar is new, it will return
     * an empty collection; or if this LeasingCalendar has previously
     * been saved, it will retrieve related LeasingUnitCalendars from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in LeasingCalendar.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|LeasingUnitCalendar[] List of LeasingUnitCalendar objects
     */
    public function getLeasingUnitCalendarsJoinLeasingUnit($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = LeasingUnitCalendarQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(LeasingCalendarPeer::DEFAULT_STRING_FORMAT);
    }
