...
abstract class BaseLeasingUnitCalendar extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Leasing\\CoreBundle\\Model\\LeasingUnitCalendarPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        LeasingUnitCalendarPeer
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = LeasingUnitCalendarPeer::ID;
        }
    ...
    public function setCalendarId($v)
    {
        ...
        if ($this->calendar_id !== $v) {
            $this->calendar_id = $v;
            $this->modifiedColumns[] = LeasingUnitCalendarPeer::CALENDAR_ID;
        }

        if ($this->aLeasingCalendar !== null && $this->aLeasingCalendar->getId() !== $v) {
    ...
    public function setUnitId($v)
    {
        ...
        if ($this->unit_id !== $v) {
            $this->unit_id = $v;
            $this->modifiedColumns[] = LeasingUnitCalendarPeer::UNIT_ID;
        }
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[] = LeasingUnitCalendarPeer::STATUS;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->calendar_id = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
            ...
            return $startcol + 4; // 4 = LeasingUnitCalendarPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating LeasingUnitCalendar object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aLeasingCalendar !== null && $this->calendar_id !== $this->aLeasingCalendar->getId()) {
            $this->aLeasingCalendar = null;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = LeasingUnitCalendarPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = LeasingUnitCalendarQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                LeasingUnitCalendarPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(LeasingUnitCalendarPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(LeasingUnitCalendarPeer::CALENDAR_ID)) {
            $modifiedColumns[':p' . $index++]  = '`calendar_id`';
        }
        if ($this->isColumnModified(LeasingUnitCalendarPeer::UNIT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`unit_id`';
        }
        if ($this->isColumnModified(LeasingUnitCalendarPeer::STATUS)) {
            $modifiedColumns[':p' . $index++]  = '`status`';
        }

        $sql = sprintf(
            'INSERT INTO `unit_calendar` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aLeasingCalendar !== null) {
                if (!$this->aLeasingCalendar->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aLeasingCalendar->getValidationFailures());
                }
            }
            ...
            if (($retval = LeasingUnitCalendarPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = LeasingUnitCalendarPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['LeasingUnitCalendar'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['LeasingUnitCalendar'][$this->getPrimaryKey()] = true;
        $keys = LeasingUnitCalendarPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aLeasingCalendar) {
                $result['LeasingCalendar'] = $this->aLeasingCalendar->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LeasingUnitCalendarPeer::ID)) $criteria->add(LeasingUnitCalendarPeer::ID, $this->id);
        if ($this->isColumnModified(LeasingUnitCalendarPeer::CALENDAR_ID)) $criteria->add(LeasingUnitCalendarPeer::CALENDAR_ID, $this->calendar_id);
        if ($this->isColumnModified(LeasingUnitCalendarPeer::UNIT_ID)) $criteria->add(LeasingUnitCalendarPeer::UNIT_ID, $this->unit_id);
        if ($this->isColumnModified(LeasingUnitCalendarPeer::STATUS)) $criteria->add(LeasingUnitCalendarPeer::STATUS, $this->status);
    ...
    {
        $criteria = new Criteria(LeasingUnitCalendarPeer::DATABASE_NAME);
        $criteria->add(LeasingUnitCalendarPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of LeasingUnitCalendar (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return LeasingUnitCalendar Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return LeasingUnitCalendarPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new LeasingUnitCalendarPeer();
        }
    ...
    /**
     * Get the associated LeasingCalendar object
     *
     * @param PropelPDO $con Optional Connection object.
     * @param $doQuery Executes a query to get the object if required
     * @return LeasingCalendar The associated LeasingCalendar object.
     * @throws PropelException
     */
    public function getLeasingCalendar(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aLeasingCalendar === null && ($this->calendar_id !== null) && $doQuery) {
            $this->aLeasingCalendar = LeasingCalendarQuery::create()->findPk($this->calendar_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aLeasingCalendar->addLeasingUnitCalendars($this);
             */
        }

        return $this->aLeasingCalendar;
    }
    ...
    public function getLeasingUnit(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aLeasingUnit === null && ($this->unit_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aLeasingUnit->addLeasingUnitCalendars($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(LeasingUnitCalendarPeer::DEFAULT_STRING_FORMAT);
    }
