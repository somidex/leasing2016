...
abstract class BaseLeasingBookingLeads extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Leasing\\CoreBundle\\Model\\LeasingBookingLeadsPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        LeasingBookingLeadsPeer
     */
     ...
     * @return LeasingBookingLeads The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = LeasingBookingLeadsPeer::ID;
        }
    ...
    public function setFname($v)
    {
        ...
        if ($this->fname !== $v) {
            $this->fname = $v;
            $this->modifiedColumns[] = LeasingBookingLeadsPeer::FNAME;
        }
    ...
    public function setLname($v)
    {
        ...
        if ($this->lname !== $v) {
            $this->lname = $v;
            $this->modifiedColumns[] = LeasingBookingLeadsPeer::LNAME;
        }
    ...
    public function setEmail($v)
    {
        ...
        if ($this->email !== $v) {
            $this->email = $v;
            $this->modifiedColumns[] = LeasingBookingLeadsPeer::EMAIL;
        }
    ...
    public function setMobile($v)
    {
        ...
        if ($this->mobile !== $v) {
            $this->mobile = $v;
            $this->modifiedColumns[] = LeasingBookingLeadsPeer::MOBILE;
        }
    ...
    public function setCountryId($v)
    {
        ...
        if ($this->country_id !== $v) {
            $this->country_id = $v;
            $this->modifiedColumns[] = LeasingBookingLeadsPeer::COUNTRY_ID;
        }
    ...
    public function setNationalityId($v)
    {
        ...
        if ($this->nationality_id !== $v) {
            ...
            $this->modifiedColumns[] = LeasingBookingLeadsPeer::NATIONALITY_ID;
        }
    ...
    public function setClientIp($v)
    {
        ...
        if ($this->client_ip !== $v) {
            $this->client_ip = $v;
            $this->modifiedColumns[] = LeasingBookingLeadsPeer::CLIENT_IP;
        }
    ...
    public function setClientId($v)
    {
        ...
        if ($this->client_id !== $v) {
            $this->client_id = $v;
            $this->modifiedColumns[] = LeasingBookingLeadsPeer::CLIENT_ID;
        }
    ...
    public function setCampaign($v)
    {
        ...
        if ($this->campaign !== $v) {
            $this->campaign = $v;
            $this->modifiedColumns[] = LeasingBookingLeadsPeer::CAMPAIGN;
        }
    ...
    public function setMedium($v)
    {
        ...
        if ($this->medium !== $v) {
            $this->medium = $v;
            $this->modifiedColumns[] = LeasingBookingLeadsPeer::MEDIUM;
        }
    ...
    public function setSource($v)
    {
        ...
        if ($this->source !== $v) {
            $this->source = $v;
            $this->modifiedColumns[] = LeasingBookingLeadsPeer::SOURCE;
        }
    ...
    public function setGacountry($v)
    {
        ...
        if ($this->gacountry !== $v) {
            $this->gacountry = $v;
            $this->modifiedColumns[] = LeasingBookingLeadsPeer::GACOUNTRY;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 13; // 13 = LeasingBookingLeadsPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating LeasingBookingLeads object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = LeasingBookingLeadsPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = LeasingBookingLeadsQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                LeasingBookingLeadsPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(LeasingBookingLeadsPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(LeasingBookingLeadsPeer::FNAME)) {
            $modifiedColumns[':p' . $index++]  = '`fname`';
        }
        if ($this->isColumnModified(LeasingBookingLeadsPeer::LNAME)) {
            $modifiedColumns[':p' . $index++]  = '`lname`';
        }
        if ($this->isColumnModified(LeasingBookingLeadsPeer::EMAIL)) {
            $modifiedColumns[':p' . $index++]  = '`email`';
        }
        if ($this->isColumnModified(LeasingBookingLeadsPeer::MOBILE)) {
            $modifiedColumns[':p' . $index++]  = '`mobile`';
        }
        if ($this->isColumnModified(LeasingBookingLeadsPeer::COUNTRY_ID)) {
            $modifiedColumns[':p' . $index++]  = '`country_id`';
        }
        if ($this->isColumnModified(LeasingBookingLeadsPeer::NATIONALITY_ID)) {
            $modifiedColumns[':p' . $index++]  = '`nationality_id`';
        }
        if ($this->isColumnModified(LeasingBookingLeadsPeer::CLIENT_IP)) {
            $modifiedColumns[':p' . $index++]  = '`client_ip`';
        }
        if ($this->isColumnModified(LeasingBookingLeadsPeer::CLIENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`client_id`';
        }
        if ($this->isColumnModified(LeasingBookingLeadsPeer::CAMPAIGN)) {
            $modifiedColumns[':p' . $index++]  = '`campaign`';
        }
        if ($this->isColumnModified(LeasingBookingLeadsPeer::MEDIUM)) {
            $modifiedColumns[':p' . $index++]  = '`medium`';
        }
        if ($this->isColumnModified(LeasingBookingLeadsPeer::SOURCE)) {
            $modifiedColumns[':p' . $index++]  = '`source`';
        }
        if ($this->isColumnModified(LeasingBookingLeadsPeer::GACOUNTRY)) {
            $modifiedColumns[':p' . $index++]  = '`gacountry`';
        }

        $sql = sprintf(
            'INSERT INTO `booking_leads` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = LeasingBookingLeadsPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = LeasingBookingLeadsPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['LeasingBookingLeads'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['LeasingBookingLeads'][$this->getPrimaryKey()] = true;
        $keys = LeasingBookingLeadsPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LeasingBookingLeadsPeer::ID)) $criteria->add(LeasingBookingLeadsPeer::ID, $this->id);
        if ($this->isColumnModified(LeasingBookingLeadsPeer::FNAME)) $criteria->add(LeasingBookingLeadsPeer::FNAME, $this->fname);
        if ($this->isColumnModified(LeasingBookingLeadsPeer::LNAME)) $criteria->add(LeasingBookingLeadsPeer::LNAME, $this->lname);
        if ($this->isColumnModified(LeasingBookingLeadsPeer::EMAIL)) $criteria->add(LeasingBookingLeadsPeer::EMAIL, $this->email);
        if ($this->isColumnModified(LeasingBookingLeadsPeer::MOBILE)) $criteria->add(LeasingBookingLeadsPeer::MOBILE, $this->mobile);
        if ($this->isColumnModified(LeasingBookingLeadsPeer::COUNTRY_ID)) $criteria->add(LeasingBookingLeadsPeer::COUNTRY_ID, $this->country_id);
        if ($this->isColumnModified(LeasingBookingLeadsPeer::NATIONALITY_ID)) $criteria->add(LeasingBookingLeadsPeer::NATIONALITY_ID, $this->nationality_id);
        if ($this->isColumnModified(LeasingBookingLeadsPeer::CLIENT_IP)) $criteria->add(LeasingBookingLeadsPeer::CLIENT_IP, $this->client_ip);
        if ($this->isColumnModified(LeasingBookingLeadsPeer::CLIENT_ID)) $criteria->add(LeasingBookingLeadsPeer::CLIENT_ID, $this->client_id);
        if ($this->isColumnModified(LeasingBookingLeadsPeer::CAMPAIGN)) $criteria->add(LeasingBookingLeadsPeer::CAMPAIGN, $this->campaign);
        if ($this->isColumnModified(LeasingBookingLeadsPeer::MEDIUM)) $criteria->add(LeasingBookingLeadsPeer::MEDIUM, $this->medium);
        if ($this->isColumnModified(LeasingBookingLeadsPeer::SOURCE)) $criteria->add(LeasingBookingLeadsPeer::SOURCE, $this->source);
        if ($this->isColumnModified(LeasingBookingLeadsPeer::GACOUNTRY)) $criteria->add(LeasingBookingLeadsPeer::GACOUNTRY, $this->gacountry);
    ...
    {
        $criteria = new Criteria(LeasingBookingLeadsPeer::DATABASE_NAME);
        $criteria->add(LeasingBookingLeadsPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of LeasingBookingLeads (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return LeasingBookingLeads Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return LeasingBookingLeadsPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new LeasingBookingLeadsPeer();
        }
    ...
    public function getLeasingCountry(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aLeasingCountry === null && ($this->country_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aLeasingCountry->addLeasingBookingLeadss($this);
             */
        }
    ...
    public function getLeasingNationality(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aLeasingNationality === null && ($this->nationality_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aLeasingNationality->addLeasingBookingLeadss($this);
             */
        }
     ...
     * If this LeasingBookingLeads is new, it will return
        ...
        if (null === $this->collLeasingBookingss || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collLeasingBookingss) {
                ...
                $collLeasingBookingss = LeasingBookingsQuery::create(null, $criteria)
                    ->filterByLeasingBookingLeads($this)
                    ->find($con);
                if (null !== $criteria) {
    ...
    public function setLeasingBookingss(PropelCollection $leasingBookingss, PropelPDO $con = null)
    {
        ...
        foreach ($leasingBookingssToDelete as $leasingBookingsRemoved) {
            $leasingBookingsRemoved->setLeasingBookingLeads(null);
        }
    ...
    protected function doAddLeasingBookings($leasingBookings)
    {
        ...
        $leasingBookings->setLeasingBookingLeads($this);
    }
    ...
    public function removeLeasingBookings($leasingBookings)
    {
        if ($this->getLeasingBookingss()->contains($leasingBookings)) {
            ...
            $leasingBookings->setLeasingBookingLeads(null);
        }
     ...
     * Otherwise if this LeasingBookingLeads is new, it will return
     * an empty collection; or if this LeasingBookingLeads has previously
     * been saved, it will retrieve related LeasingBookingss from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in LeasingBookingLeads.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|LeasingBookings[] List of LeasingBookings objects
     */
    public function getLeasingBookingssJoinLeasingUnit($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = LeasingBookingsQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(LeasingBookingLeadsPeer::DEFAULT_STRING_FORMAT);
    }
