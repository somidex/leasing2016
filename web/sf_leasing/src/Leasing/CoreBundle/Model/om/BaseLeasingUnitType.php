...
abstract class BaseLeasingUnitType extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Leasing\\CoreBundle\\Model\\LeasingUnitTypePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        LeasingUnitTypePeer
     */
     ...
     * @return LeasingUnitType The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = LeasingUnitTypePeer::ID;
        }
    ...
    public function setTypeName($v)
    {
        ...
        if ($this->type_name !== $v) {
            $this->type_name = $v;
            $this->modifiedColumns[] = LeasingUnitTypePeer::TYPE_NAME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->type_name = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->resetModified();
            ...
            return $startcol + 2; // 2 = LeasingUnitTypePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating LeasingUnitType object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = LeasingUnitTypePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = LeasingUnitTypeQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                LeasingUnitTypePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(LeasingUnitTypePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(LeasingUnitTypePeer::TYPE_NAME)) {
            $modifiedColumns[':p' . $index++]  = '`type_name`';
        }

        $sql = sprintf(
            'INSERT INTO `unit_type` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = LeasingUnitTypePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = LeasingUnitTypePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['LeasingUnitType'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['LeasingUnitType'][$this->getPrimaryKey()] = true;
        $keys = LeasingUnitTypePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LeasingUnitTypePeer::ID)) $criteria->add(LeasingUnitTypePeer::ID, $this->id);
        if ($this->isColumnModified(LeasingUnitTypePeer::TYPE_NAME)) $criteria->add(LeasingUnitTypePeer::TYPE_NAME, $this->type_name);
    ...
    {
        $criteria = new Criteria(LeasingUnitTypePeer::DATABASE_NAME);
        $criteria->add(LeasingUnitTypePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of LeasingUnitType (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return LeasingUnitType Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return LeasingUnitTypePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new LeasingUnitTypePeer();
        }
     ...
     * If this LeasingUnitType is new, it will return
    ...
    public function setLeasingUnits(PropelCollection $leasingUnits, PropelPDO $con = null)
    {
        ...
        foreach ($leasingUnitsToDelete as $leasingUnitRemoved) {
            $leasingUnitRemoved->setLeasingUnitType(null);
        }
    ...
    protected function doAddLeasingUnit($leasingUnit)
    {
        ...
        $leasingUnit->setLeasingUnitType($this);
    }
    ...
    public function removeLeasingUnit($leasingUnit)
    {
        if ($this->getLeasingUnits()->contains($leasingUnit)) {
            ...
            $leasingUnit->setLeasingUnitType(null);
        }
     ...
     * Otherwise if this LeasingUnitType is new, it will return
     * an empty collection; or if this LeasingUnitType has previously
     * been saved, it will retrieve related LeasingUnits from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in LeasingUnitType.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(LeasingUnitTypePeer::DEFAULT_STRING_FORMAT);
    }
