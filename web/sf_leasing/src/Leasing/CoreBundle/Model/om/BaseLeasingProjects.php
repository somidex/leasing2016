...
abstract class BaseLeasingProjects extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Leasing\\CoreBundle\\Model\\LeasingProjectsPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        LeasingProjectsPeer
     */
     ...
     * @return LeasingProjects The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = LeasingProjectsPeer::ID;
        }
    ...
    public function setProject($v)
    {
        ...
        if ($this->project !== $v) {
            $this->project = $v;
            $this->modifiedColumns[] = LeasingProjectsPeer::PROJECT;
        }
    ...
    public function setCode($v)
    {
        ...
        if ($this->code !== $v) {
            $this->code = $v;
            $this->modifiedColumns[] = LeasingProjectsPeer::CODE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->project = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            ...
            return $startcol + 3; // 3 = LeasingProjectsPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating LeasingProjects object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = LeasingProjectsPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = LeasingProjectsQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                LeasingProjectsPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(LeasingProjectsPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(LeasingProjectsPeer::PROJECT)) {
            $modifiedColumns[':p' . $index++]  = '`project`';
        }
        if ($this->isColumnModified(LeasingProjectsPeer::CODE)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = LeasingProjectsPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = LeasingProjectsPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['LeasingProjects'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['LeasingProjects'][$this->getPrimaryKey()] = true;
        $keys = LeasingProjectsPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setProject($arr[$keys[1]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LeasingProjectsPeer::ID)) $criteria->add(LeasingProjectsPeer::ID, $this->id);
        if ($this->isColumnModified(LeasingProjectsPeer::PROJECT)) $criteria->add(LeasingProjectsPeer::PROJECT, $this->project);
        if ($this->isColumnModified(LeasingProjectsPeer::CODE)) $criteria->add(LeasingProjectsPeer::CODE, $this->code);
    ...
    {
        $criteria = new Criteria(LeasingProjectsPeer::DATABASE_NAME);
        $criteria->add(LeasingProjectsPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of LeasingProjects (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return LeasingProjects Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return LeasingProjectsPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new LeasingProjectsPeer();
        }
     ...
     * If this LeasingProjects is new, it will return
    ...
    public function setLeasingUnits(PropelCollection $leasingUnits, PropelPDO $con = null)
    {
        ...
        foreach ($leasingUnitsToDelete as $leasingUnitRemoved) {
            $leasingUnitRemoved->setLeasingProjects(null);
        }
    ...
    public function removeLeasingUnit($leasingUnit)
    {
        if ($this->getLeasingUnits()->contains($leasingUnit)) {
            ...
            $leasingUnit->setLeasingProjects(null);
        }
     ...
     * Otherwise if this LeasingProjects is new, it will return
     * an empty collection; or if this LeasingProjects has previously
     * been saved, it will retrieve related LeasingUnits from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in LeasingProjects.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(LeasingProjectsPeer::DEFAULT_STRING_FORMAT);
    }
