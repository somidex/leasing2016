...
abstract class BaseLeasingAppointments extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the lease_period field.
     * @var        int
     */
    protected $lease_period;

    /**
     * The value for the target_move_in field.
     * @var        string
     */
    protected $target_move_in;
    ...
    /**
     * Get the [lease_period] column value.
     *
     * @return int
     */
    ...
    /**
     * Get the [target_move_in] column value.
     *
     * @return string
     */
    public function getTargetMoveIn()
    {

        return $this->target_move_in;
    }
    ...
    /**
     * Set the value of [lease_period] column.
     *
     * @param  int $v new value
     * @return LeasingAppointments The current object (for fluent API support)
     */
    public function setLeasePeriod($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->lease_period !== $v) {
            $this->lease_period = $v;
            $this->modifiedColumns[] = LeasingAppointmentsPeer::LEASE_PERIOD;
        }
    ...
    /**
     * Set the value of [target_move_in] column.
     *
     * @param  string $v new value
     * @return LeasingAppointments The current object (for fluent API support)
     */
    public function setTargetMoveIn($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->target_move_in !== $v) {
            $this->target_move_in = $v;
            $this->modifiedColumns[] = LeasingAppointmentsPeer::TARGET_MOVE_IN;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->lease_period = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
            $this->target_move_in = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
            $this->confirmation_code = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
            ...
            $this->first_heard = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
            $this->notes = ($row[$startcol + 11] !== null) ? (string) $row[$startcol + 11] : null;
            $this->date_added = ($row[$startcol + 12] !== null) ? (string) $row[$startcol + 12] : null;
            $this->status = ($row[$startcol + 13] !== null) ? (int) $row[$startcol + 13] : null;
            $this->prev_status = ($row[$startcol + 14] !== null) ? (int) $row[$startcol + 14] : null;
            $this->processing = ($row[$startcol + 15] !== null) ? (int) $row[$startcol + 15] : null;
            $this->processed_by = ($row[$startcol + 16] !== null) ? (string) $row[$startcol + 16] : null;
            $this->resetModified();
            ...
            return $startcol + 17; // 17 = LeasingAppointmentsPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(LeasingAppointmentsPeer::LEASE_PERIOD)) {
            $modifiedColumns[':p' . $index++]  = '`lease_period`';
        }
        if ($this->isColumnModified(LeasingAppointmentsPeer::TARGET_MOVE_IN)) {
            $modifiedColumns[':p' . $index++]  = '`target_move_in`';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`preferred_time`':
                        ...
                        break;
                    case '`lease_period`':
                        $stmt->bindValue($identifier, $this->lease_period, PDO::PARAM_INT);
                        break;
                    case '`target_move_in`':
                        $stmt->bindValue($identifier, $this->target_move_in, PDO::PARAM_STR);
                        break;
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 4:
                ...
                break;
            case 5:
                return $this->getLeasePeriod();
                break;
            case 6:
                return $this->getTargetMoveIn();
                break;
            case 7:
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[5] => $this->getLeasePeriod(),
            $keys[6] => $this->getTargetMoveIn(),
            $keys[7] => $this->getConfirmationCode(),
            $keys[8] => $this->getStartDate(),
            $keys[9] => $this->getEndDate(),
            $keys[10] => $this->getFirstHeard(),
            $keys[11] => $this->getNotes(),
            $keys[12] => $this->getDateAdded(),
            $keys[13] => $this->getStatus(),
            $keys[14] => $this->getPrevStatus(),
            $keys[15] => $this->getProcessing(),
            $keys[16] => $this->getProcessedBy(),
        );
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 4:
                ...
                break;
            case 5:
                $this->setLeasePeriod($value);
                break;
            case 6:
                $this->setTargetMoveIn($value);
                break;
            case 7:
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[5], $arr)) $this->setLeasePeriod($arr[$keys[5]]);
        if (array_key_exists($keys[6], $arr)) $this->setTargetMoveIn($arr[$keys[6]]);
        if (array_key_exists($keys[7], $arr)) $this->setConfirmationCode($arr[$keys[7]]);
        if (array_key_exists($keys[8], $arr)) $this->setStartDate($arr[$keys[8]]);
        if (array_key_exists($keys[9], $arr)) $this->setEndDate($arr[$keys[9]]);
        if (array_key_exists($keys[10], $arr)) $this->setFirstHeard($arr[$keys[10]]);
        if (array_key_exists($keys[11], $arr)) $this->setNotes($arr[$keys[11]]);
        if (array_key_exists($keys[12], $arr)) $this->setDateAdded($arr[$keys[12]]);
        if (array_key_exists($keys[13], $arr)) $this->setStatus($arr[$keys[13]]);
        if (array_key_exists($keys[14], $arr)) $this->setPrevStatus($arr[$keys[14]]);
        if (array_key_exists($keys[15], $arr)) $this->setProcessing($arr[$keys[15]]);
        if (array_key_exists($keys[16], $arr)) $this->setProcessedBy($arr[$keys[16]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LeasingAppointmentsPeer::LEASE_PERIOD)) $criteria->add(LeasingAppointmentsPeer::LEASE_PERIOD, $this->lease_period);
        if ($this->isColumnModified(LeasingAppointmentsPeer::TARGET_MOVE_IN)) $criteria->add(LeasingAppointmentsPeer::TARGET_MOVE_IN, $this->target_move_in);
    ...
    public function clear()
    {
        ...
        $this->lease_period = null;
        $this->target_move_in = null;
