...
abstract class BaseLeasingDocument extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Leasing\\CoreBundle\\Model\\LeasingDocumentPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        LeasingDocumentPeer
     */
     ...
     * @return LeasingDocument The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = LeasingDocumentPeer::ID;
        }
    ...
    public function setDocument($v)
    {
        ...
        if ($this->document !== $v) {
            $this->document = $v;
            $this->modifiedColumns[] = LeasingDocumentPeer::DOCUMENT;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->document = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->resetModified();
            ...
            return $startcol + 2; // 2 = LeasingDocumentPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating LeasingDocument object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = LeasingDocumentPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = LeasingDocumentQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                LeasingDocumentPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(LeasingDocumentPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(LeasingDocumentPeer::DOCUMENT)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = LeasingDocumentPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = LeasingDocumentPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['LeasingDocument'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['LeasingDocument'][$this->getPrimaryKey()] = true;
        $keys = LeasingDocumentPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setDocument($arr[$keys[1]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LeasingDocumentPeer::ID)) $criteria->add(LeasingDocumentPeer::ID, $this->id);
        if ($this->isColumnModified(LeasingDocumentPeer::DOCUMENT)) $criteria->add(LeasingDocumentPeer::DOCUMENT, $this->document);
    ...
    {
        $criteria = new Criteria(LeasingDocumentPeer::DATABASE_NAME);
        $criteria->add(LeasingDocumentPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of LeasingDocument (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return LeasingDocument Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return LeasingDocumentPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new LeasingDocumentPeer();
        }
     ...
     * If this LeasingDocument is new, it will return
    ...
    public function setLeasingLeadDocuments(PropelCollection $leasingLeadDocuments, PropelPDO $con = null)
    {
        ...
        foreach ($leasingLeadDocumentsToDelete as $leasingLeadDocumentRemoved) {
            $leasingLeadDocumentRemoved->setLeasingDocument(null);
        }
    ...
    protected function doAddLeasingLeadDocument($leasingLeadDocument)
    {
        ...
        $leasingLeadDocument->setLeasingDocument($this);
    }
    ...
    public function removeLeasingLeadDocument($leasingLeadDocument)
    {
        if ($this->getLeasingLeadDocuments()->contains($leasingLeadDocument)) {
            ...
            $leasingLeadDocument->setLeasingDocument(null);
        }
     ...
     * Otherwise if this LeasingDocument is new, it will return
     * an empty collection; or if this LeasingDocument has previously
     * been saved, it will retrieve related LeasingLeadDocuments from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in LeasingDocument.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|LeasingLeadDocument[] List of LeasingLeadDocument objects
     */
    public function getLeasingLeadDocumentsJoinLeasingLeadType($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = LeasingLeadDocumentQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(LeasingDocumentPeer::DEFAULT_STRING_FORMAT);
    }
