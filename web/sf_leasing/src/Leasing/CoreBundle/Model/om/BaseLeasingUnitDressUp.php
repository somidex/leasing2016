...
abstract class BaseLeasingUnitDressUp extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Leasing\\CoreBundle\\Model\\LeasingUnitDressUpPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        LeasingUnitDressUpPeer
     */
    ...
    /**
     * The value for the dress_up field.
     * @var        string
     */
    protected $dress_up;
     ...
     * @return LeasingUnitDressUp The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = LeasingUnitDressUpPeer::ID;
        }
    ...
    /**
     * Set the value of [dress_up] column.
     *
     * @param  string $v new value
     * @return LeasingUnitDressUp The current object (for fluent API support)
     */
    public function setDressUp($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->dress_up !== $v) {
            $this->dress_up = $v;
            $this->modifiedColumns[] = LeasingUnitDressUpPeer::DRESS_UP;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->dress_up = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->resetModified();
            ...
            return $startcol + 2; // 2 = LeasingUnitDressUpPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating LeasingUnitDressUp object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = LeasingUnitDressUpPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = LeasingUnitDressUpQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                LeasingUnitDressUpPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(LeasingUnitDressUpPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(LeasingUnitDressUpPeer::DRESS_UP)) {
            $modifiedColumns[':p' . $index++]  = '`dress_up`';
        }

        $sql = sprintf(
            'INSERT INTO `unit_dress_up` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`id`':
                        ...
                        break;
                    case '`dress_up`':
                        $stmt->bindValue($identifier, $this->dress_up, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = LeasingUnitDressUpPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = LeasingUnitDressUpPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['LeasingUnitDressUp'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['LeasingUnitDressUp'][$this->getPrimaryKey()] = true;
        $keys = LeasingUnitDressUpPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getDressUp(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setDressUp($arr[$keys[1]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LeasingUnitDressUpPeer::ID)) $criteria->add(LeasingUnitDressUpPeer::ID, $this->id);
        if ($this->isColumnModified(LeasingUnitDressUpPeer::DRESS_UP)) $criteria->add(LeasingUnitDressUpPeer::DRESS_UP, $this->dress_up);
    ...
    {
        $criteria = new Criteria(LeasingUnitDressUpPeer::DATABASE_NAME);
        $criteria->add(LeasingUnitDressUpPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of LeasingUnitDressUp (or compatible) type.
    ...
    {
        $copyObj->setDressUp($this->getDressUp());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return LeasingUnitDressUp Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return LeasingUnitDressUpPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new LeasingUnitDressUpPeer();
        }
     ...
     * If this LeasingUnitDressUp is new, it will return
        ...
        if (null === $this->collLeasingUnits || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collLeasingUnits) {
                ...
                $collLeasingUnits = LeasingUnitQuery::create(null, $criteria)
                    ->filterByLeasingUnitDressUp($this)
                    ->find($con);
                if (null !== $criteria) {
    ...
    public function setLeasingUnits(PropelCollection $leasingUnits, PropelPDO $con = null)
    {
        ...
        foreach ($leasingUnitsToDelete as $leasingUnitRemoved) {
            $leasingUnitRemoved->setLeasingUnitDressUp(null);
        }
    ...
    public function removeLeasingUnit($leasingUnit)
    {
        if ($this->getLeasingUnits()->contains($leasingUnit)) {
            ...
            $leasingUnit->setLeasingUnitDressUp(null);
        }
     ...
     * Otherwise if this LeasingUnitDressUp is new, it will return
     * an empty collection; or if this LeasingUnitDressUp has previously
     * been saved, it will retrieve related LeasingUnits from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in LeasingUnitDressUp.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(LeasingUnitDressUpPeer::DEFAULT_STRING_FORMAT);
    }
