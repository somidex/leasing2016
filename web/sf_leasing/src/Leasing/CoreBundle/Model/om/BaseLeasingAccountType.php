...
abstract class BaseLeasingAccountType extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Leasing\\CoreBundle\\Model\\LeasingAccountTypePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        LeasingAccountTypePeer
     */
     ...
     * @return LeasingAccountType The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = LeasingAccountTypePeer::ID;
        }
    ...
    public function setAccountType($v)
    {
        ...
        if ($this->account_type !== $v) {
            $this->account_type = $v;
            $this->modifiedColumns[] = LeasingAccountTypePeer::ACCOUNT_TYPE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->account_type = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->resetModified();
            ...
            return $startcol + 2; // 2 = LeasingAccountTypePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating LeasingAccountType object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = LeasingAccountTypePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = LeasingAccountTypeQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                LeasingAccountTypePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(LeasingAccountTypePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(LeasingAccountTypePeer::ACCOUNT_TYPE)) {
            $modifiedColumns[':p' . $index++]  = '`account_type`';
        }

        $sql = sprintf(
            'INSERT INTO `residential_account_type` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = LeasingAccountTypePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = LeasingAccountTypePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['LeasingAccountType'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['LeasingAccountType'][$this->getPrimaryKey()] = true;
        $keys = LeasingAccountTypePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LeasingAccountTypePeer::ID)) $criteria->add(LeasingAccountTypePeer::ID, $this->id);
        if ($this->isColumnModified(LeasingAccountTypePeer::ACCOUNT_TYPE)) $criteria->add(LeasingAccountTypePeer::ACCOUNT_TYPE, $this->account_type);
    ...
    {
        $criteria = new Criteria(LeasingAccountTypePeer::DATABASE_NAME);
        $criteria->add(LeasingAccountTypePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of LeasingAccountType (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return LeasingAccountType Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return LeasingAccountTypePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new LeasingAccountTypePeer();
        }
     ...
     * If this LeasingAccountType is new, it will return
        ...
        if (null === $this->collLeasingTenantss || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collLeasingTenantss) {
                ...
                $collLeasingTenantss = LeasingTenantsQuery::create(null, $criteria)
                    ->filterByLeasingAccountType($this)
                    ->find($con);
                if (null !== $criteria) {
    ...
    public function setLeasingTenantss(PropelCollection $leasingTenantss, PropelPDO $con = null)
    {
        ...
        foreach ($leasingTenantssToDelete as $leasingTenantsRemoved) {
            $leasingTenantsRemoved->setLeasingAccountType(null);
        }
    ...
    protected function doAddLeasingTenants($leasingTenants)
    {
        ...
        $leasingTenants->setLeasingAccountType($this);
    }
    ...
    public function removeLeasingTenants($leasingTenants)
    {
        if ($this->getLeasingTenantss()->contains($leasingTenants)) {
            ...
            $leasingTenants->setLeasingAccountType(null);
        }
     ...
     * Otherwise if this LeasingAccountType is new, it will return
     * an empty collection; or if this LeasingAccountType has previously
     * been saved, it will retrieve related LeasingTenantss from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in LeasingAccountType.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(LeasingAccountTypePeer::DEFAULT_STRING_FORMAT);
    }
