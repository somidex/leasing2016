...
abstract class BaseLeasingUnitNumberBedrooms extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Leasing\\CoreBundle\\Model\\LeasingUnitNumberBedroomsPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        LeasingUnitNumberBedroomsPeer
     */
    ...
    /**
     * The value for the br_code field.
     * @var        string
     */
    protected $br_code;
     ...
     * @return LeasingUnitNumberBedrooms The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = LeasingUnitNumberBedroomsPeer::ID;
        }
    ...
    public function setBedrooms($v)
    {
        ...
        if ($this->bedrooms !== $v) {
            $this->bedrooms = $v;
            $this->modifiedColumns[] = LeasingUnitNumberBedroomsPeer::BEDROOMS;
        }
    ...
    /**
     * Set the value of [br_code] column.
     *
     * @param  string $v new value
     * @return LeasingUnitNumberBedrooms The current object (for fluent API support)
     */
    public function setBrCode($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->br_code !== $v) {
            $this->br_code = $v;
            $this->modifiedColumns[] = LeasingUnitNumberBedroomsPeer::BR_CODE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->bedrooms = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->br_code = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->resetModified();
            ...
            return $startcol + 3; // 3 = LeasingUnitNumberBedroomsPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating LeasingUnitNumberBedrooms object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = LeasingUnitNumberBedroomsPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = LeasingUnitNumberBedroomsQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                LeasingUnitNumberBedroomsPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(LeasingUnitNumberBedroomsPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(LeasingUnitNumberBedroomsPeer::BEDROOMS)) {
            $modifiedColumns[':p' . $index++]  = '`bedrooms`';
        }
        if ($this->isColumnModified(LeasingUnitNumberBedroomsPeer::BR_CODE)) {
            $modifiedColumns[':p' . $index++]  = '`br_code`';
        }

        $sql = sprintf(
            'INSERT INTO `unit_no_br` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`id`':
                        ...
                        break;
                    case '`bedrooms`':
                        $stmt->bindValue($identifier, $this->bedrooms, PDO::PARAM_STR);
                        break;
                    case '`br_code`':
                        $stmt->bindValue($identifier, $this->br_code, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = LeasingUnitNumberBedroomsPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = LeasingUnitNumberBedroomsPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['LeasingUnitNumberBedrooms'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['LeasingUnitNumberBedrooms'][$this->getPrimaryKey()] = true;
        $keys = LeasingUnitNumberBedroomsPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getBedrooms(),
            $keys[2] => $this->getBrCode(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setBedrooms($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setBrCode($arr[$keys[2]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LeasingUnitNumberBedroomsPeer::ID)) $criteria->add(LeasingUnitNumberBedroomsPeer::ID, $this->id);
        if ($this->isColumnModified(LeasingUnitNumberBedroomsPeer::BEDROOMS)) $criteria->add(LeasingUnitNumberBedroomsPeer::BEDROOMS, $this->bedrooms);
        if ($this->isColumnModified(LeasingUnitNumberBedroomsPeer::BR_CODE)) $criteria->add(LeasingUnitNumberBedroomsPeer::BR_CODE, $this->br_code);
    ...
    {
        $criteria = new Criteria(LeasingUnitNumberBedroomsPeer::DATABASE_NAME);
        $criteria->add(LeasingUnitNumberBedroomsPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of LeasingUnitNumberBedrooms (or compatible) type.
    ...
    {
        $copyObj->setBedrooms($this->getBedrooms());
        $copyObj->setBrCode($this->getBrCode());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return LeasingUnitNumberBedrooms Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return LeasingUnitNumberBedroomsPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new LeasingUnitNumberBedroomsPeer();
        }
     ...
     * If this LeasingUnitNumberBedrooms is new, it will return
        ...
        if (null === $this->collLeasingUnits || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collLeasingUnits) {
                ...
                $collLeasingUnits = LeasingUnitQuery::create(null, $criteria)
                    ->filterByLeasingUnitNumberBedrooms($this)
                    ->find($con);
                if (null !== $criteria) {
    ...
    public function setLeasingUnits(PropelCollection $leasingUnits, PropelPDO $con = null)
    {
        ...
        foreach ($leasingUnitsToDelete as $leasingUnitRemoved) {
            $leasingUnitRemoved->setLeasingUnitNumberBedrooms(null);
        }
    ...
    public function removeLeasingUnit($leasingUnit)
    {
        if ($this->getLeasingUnits()->contains($leasingUnit)) {
            ...
            $leasingUnit->setLeasingUnitNumberBedrooms(null);
        }
     ...
     * Otherwise if this LeasingUnitNumberBedrooms is new, it will return
     * an empty collection; or if this LeasingUnitNumberBedrooms has previously
     * been saved, it will retrieve related LeasingUnits from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in LeasingUnitNumberBedrooms.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(LeasingUnitNumberBedroomsPeer::DEFAULT_STRING_FORMAT);
    }
