...
abstract class BaseLeasingCountry extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Leasing\\CoreBundle\\Model\\LeasingCountryPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        LeasingCountryPeer
     */
     ...
     * @return LeasingCountry The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = LeasingCountryPeer::ID;
        }
    ...
    public function setCountryName($v)
    {
        ...
        if ($this->country_name !== $v) {
            $this->country_name = $v;
            $this->modifiedColumns[] = LeasingCountryPeer::COUNTRY_NAME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->country_name = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->resetModified();
            ...
            return $startcol + 2; // 2 = LeasingCountryPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating LeasingCountry object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = LeasingCountryPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = LeasingCountryQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                LeasingCountryPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(LeasingCountryPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(LeasingCountryPeer::COUNTRY_NAME)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = LeasingCountryPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = LeasingCountryPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['LeasingCountry'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['LeasingCountry'][$this->getPrimaryKey()] = true;
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LeasingCountryPeer::ID)) $criteria->add(LeasingCountryPeer::ID, $this->id);
        if ($this->isColumnModified(LeasingCountryPeer::COUNTRY_NAME)) $criteria->add(LeasingCountryPeer::COUNTRY_NAME, $this->country_name);
    ...
    {
        $criteria = new Criteria(LeasingCountryPeer::DATABASE_NAME);
        $criteria->add(LeasingCountryPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of LeasingCountry (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return LeasingCountry Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return LeasingCountryPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new LeasingCountryPeer();
        }
     ...
     * If this LeasingCountry is new, it will return
    ...
    public function setLeasingAppointmentLeadss(PropelCollection $leasingAppointmentLeadss, PropelPDO $con = null)
    {
        ...
        foreach ($leasingAppointmentLeadssToDelete as $leasingAppointmentLeadsRemoved) {
            $leasingAppointmentLeadsRemoved->setLeasingCountry(null);
        }
    ...
    protected function doAddLeasingAppointmentLeads($leasingAppointmentLeads)
    {
        ...
        $leasingAppointmentLeads->setLeasingCountry($this);
    }
    ...
    public function removeLeasingAppointmentLeads($leasingAppointmentLeads)
    {
        if ($this->getLeasingAppointmentLeadss()->contains($leasingAppointmentLeads)) {
            ...
            $leasingAppointmentLeads->setLeasingCountry(null);
        }
     ...
     * Otherwise if this LeasingCountry is new, it will return
     * an empty collection; or if this LeasingCountry has previously
     * been saved, it will retrieve related LeasingAppointmentLeadss from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in LeasingCountry.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|LeasingAppointmentLeads[] List of LeasingAppointmentLeads objects
     */
    public function getLeasingAppointmentLeadssJoinLeasingNationality($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = LeasingAppointmentLeadsQuery::create(null, $criteria);
        $query->joinWith('LeasingNationality', $join_behavior);
    ...
    public function setLeasingBookingLeadss(PropelCollection $leasingBookingLeadss, PropelPDO $con = null)
    {
        ...
        foreach ($leasingBookingLeadssToDelete as $leasingBookingLeadsRemoved) {
            $leasingBookingLeadsRemoved->setLeasingCountry(null);
        }
    ...
    protected function doAddLeasingBookingLeads($leasingBookingLeads)
    {
        ...
        $leasingBookingLeads->setLeasingCountry($this);
    }
    ...
    public function removeLeasingBookingLeads($leasingBookingLeads)
    {
        if ($this->getLeasingBookingLeadss()->contains($leasingBookingLeads)) {
            ...
            $leasingBookingLeads->setLeasingCountry(null);
        }
     ...
     * @return PropelObjectCollection|LeasingBookingLeads[] List of LeasingBookingLeads objects
     */
    public function getLeasingBookingLeadssJoinLeasingNationality($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = LeasingBookingLeadsQuery::create(null, $criteria);
        $query->joinWith('LeasingNationality', $join_behavior);
    ...
    public function setLeasingEventLeadss(PropelCollection $leasingEventLeadss, PropelPDO $con = null)
    {
        ...
        foreach ($leasingEventLeadssToDelete as $leasingEventLeadsRemoved) {
            $leasingEventLeadsRemoved->setLeasingCountry(null);
        }
    ...
    protected function doAddLeasingEventLeads($leasingEventLeads)
    {
        ...
        $leasingEventLeads->setLeasingCountry($this);
    }
    ...
    public function removeLeasingEventLeads($leasingEventLeads)
    {
        if ($this->getLeasingEventLeadss()->contains($leasingEventLeads)) {
            ...
            $leasingEventLeads->setLeasingCountry(null);
        }
     ...
     * @return PropelObjectCollection|LeasingEventLeads[] List of LeasingEventLeads objects
     */
    public function getLeasingEventLeadssJoinLeasingNationality($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = LeasingEventLeadsQuery::create(null, $criteria);
        $query->joinWith('LeasingNationality', $join_behavior);
    ...
    {
        return (string) $this->exportTo(LeasingCountryPeer::DEFAULT_STRING_FORMAT);
    }
