...
abstract class BaseLeasingFeatures extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Leasing\\CoreBundle\\Model\\LeasingFeaturesPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        LeasingFeaturesPeer
     */
     ...
     * @return LeasingFeatures The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = LeasingFeaturesPeer::ID;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = LeasingFeaturesPeer::NAME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = LeasingFeaturesPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating LeasingFeatures object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = LeasingFeaturesPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = LeasingFeaturesQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                LeasingFeaturesPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(LeasingFeaturesPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(LeasingFeaturesPeer::NAME)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = LeasingFeaturesPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = LeasingFeaturesPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['LeasingFeatures'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['LeasingFeatures'][$this->getPrimaryKey()] = true;
        $keys = LeasingFeaturesPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
        );
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LeasingFeaturesPeer::ID)) $criteria->add(LeasingFeaturesPeer::ID, $this->id);
        if ($this->isColumnModified(LeasingFeaturesPeer::NAME)) $criteria->add(LeasingFeaturesPeer::NAME, $this->name);
    ...
    {
        $criteria = new Criteria(LeasingFeaturesPeer::DATABASE_NAME);
        $criteria->add(LeasingFeaturesPeer::ID, $this->id);
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return LeasingFeatures Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return LeasingFeaturesPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new LeasingFeaturesPeer();
        }
     ...
     * If this LeasingFeatures is new, it will return
    ...
    public function setLeasingUnitFeaturess(PropelCollection $leasingUnitFeaturess, PropelPDO $con = null)
    {
        ...
        foreach ($leasingUnitFeaturessToDelete as $leasingUnitFeaturesRemoved) {
            $leasingUnitFeaturesRemoved->setLeasingFeatures(null);
        }
    ...
    protected function doAddLeasingUnitFeatures($leasingUnitFeatures)
    {
        ...
        $leasingUnitFeatures->setLeasingFeatures($this);
    }
    ...
    public function removeLeasingUnitFeatures($leasingUnitFeatures)
    {
        if ($this->getLeasingUnitFeaturess()->contains($leasingUnitFeatures)) {
            ...
            $leasingUnitFeatures->setLeasingFeatures(null);
        }
     ...
     * Otherwise if this LeasingFeatures is new, it will return
     * an empty collection; or if this LeasingFeatures has previously
     * been saved, it will retrieve related LeasingUnitFeaturess from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in LeasingFeatures.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|LeasingUnitFeatures[] List of LeasingUnitFeatures objects
     */
    public function getLeasingUnitFeaturessJoinLeasingUnit($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = LeasingUnitFeaturesQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(LeasingFeaturesPeer::DEFAULT_STRING_FORMAT);
    }
