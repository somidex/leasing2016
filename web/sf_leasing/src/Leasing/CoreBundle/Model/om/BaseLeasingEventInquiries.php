...
abstract class BaseLeasingEventInquiries extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Leasing\\CoreBundle\\Model\\LeasingEventInquiriesPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        LeasingEventInquiriesPeer
     */
     ...
     * @return LeasingEventInquiries The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = LeasingEventInquiriesPeer::ID;
        }
    ...
    public function setEventPlaceId($v)
    {
        ...
        if ($this->event_place_id !== $v) {
            ...
            $this->modifiedColumns[] = LeasingEventInquiriesPeer::EVENT_PLACE_ID;
        }
    ...
    public function setEventLeadsId($v)
    {
        ...
        if ($this->event_leads_id !== $v) {
            ...
            $this->modifiedColumns[] = LeasingEventInquiriesPeer::EVENT_LEADS_ID;
        }
    ...
    public function setMessage($v)
    {
        ...
        if ($this->message !== $v) {
            $this->message = $v;
            $this->modifiedColumns[] = LeasingEventInquiriesPeer::MESSAGE;
        }
    ...
    public function setDateAdded($v)
    {
        ...
        if ($this->date_added !== $v) {
            $this->date_added = $v;
            $this->modifiedColumns[] = LeasingEventInquiriesPeer::DATE_ADDED;
        }
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[] = LeasingEventInquiriesPeer::STATUS;
        }
    ...
    public function setPrevStatus($v)
    {
        ...
        if ($this->prev_status !== $v) {
            $this->prev_status = $v;
            $this->modifiedColumns[] = LeasingEventInquiriesPeer::PREV_STATUS;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->event_place_id = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
            $this->event_leads_id = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
            ...
            $this->prev_status = ($row[$startcol + 6] !== null) ? (int) $row[$startcol + 6] : null;
            $this->resetModified();
            ...
            return $startcol + 7; // 7 = LeasingEventInquiriesPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating LeasingEventInquiries object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = LeasingEventInquiriesPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = LeasingEventInquiriesQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                LeasingEventInquiriesPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(LeasingEventInquiriesPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(LeasingEventInquiriesPeer::EVENT_PLACE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`event_place_id`';
        }
        if ($this->isColumnModified(LeasingEventInquiriesPeer::EVENT_LEADS_ID)) {
            $modifiedColumns[':p' . $index++]  = '`event_leads_id`';
        }
        if ($this->isColumnModified(LeasingEventInquiriesPeer::MESSAGE)) {
            $modifiedColumns[':p' . $index++]  = '`message`';
        }
        if ($this->isColumnModified(LeasingEventInquiriesPeer::DATE_ADDED)) {
            $modifiedColumns[':p' . $index++]  = '`date_added`';
        }
        if ($this->isColumnModified(LeasingEventInquiriesPeer::STATUS)) {
            $modifiedColumns[':p' . $index++]  = '`status`';
        }
        if ($this->isColumnModified(LeasingEventInquiriesPeer::PREV_STATUS)) {
            $modifiedColumns[':p' . $index++]  = '`prev_status`';
        }

        $sql = sprintf(
            'INSERT INTO `event_inquiries` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = LeasingEventInquiriesPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = LeasingEventInquiriesPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['LeasingEventInquiries'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['LeasingEventInquiries'][$this->getPrimaryKey()] = true;
        $keys = LeasingEventInquiriesPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getEventPlaceId(),
            $keys[2] => $this->getEventLeadsId(),
            $keys[3] => $this->getMessage(),
            $keys[4] => $this->getDateAdded(),
            $keys[5] => $this->getStatus(),
            $keys[6] => $this->getPrevStatus(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setEventPlaceId($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setEventLeadsId($arr[$keys[2]]);
        ...
        if (array_key_exists($keys[6], $arr)) $this->setPrevStatus($arr[$keys[6]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LeasingEventInquiriesPeer::ID)) $criteria->add(LeasingEventInquiriesPeer::ID, $this->id);
        if ($this->isColumnModified(LeasingEventInquiriesPeer::EVENT_PLACE_ID)) $criteria->add(LeasingEventInquiriesPeer::EVENT_PLACE_ID, $this->event_place_id);
        if ($this->isColumnModified(LeasingEventInquiriesPeer::EVENT_LEADS_ID)) $criteria->add(LeasingEventInquiriesPeer::EVENT_LEADS_ID, $this->event_leads_id);
        if ($this->isColumnModified(LeasingEventInquiriesPeer::MESSAGE)) $criteria->add(LeasingEventInquiriesPeer::MESSAGE, $this->message);
        if ($this->isColumnModified(LeasingEventInquiriesPeer::DATE_ADDED)) $criteria->add(LeasingEventInquiriesPeer::DATE_ADDED, $this->date_added);
        if ($this->isColumnModified(LeasingEventInquiriesPeer::STATUS)) $criteria->add(LeasingEventInquiriesPeer::STATUS, $this->status);
        if ($this->isColumnModified(LeasingEventInquiriesPeer::PREV_STATUS)) $criteria->add(LeasingEventInquiriesPeer::PREV_STATUS, $this->prev_status);
    ...
    {
        $criteria = new Criteria(LeasingEventInquiriesPeer::DATABASE_NAME);
        $criteria->add(LeasingEventInquiriesPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of LeasingEventInquiries (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return LeasingEventInquiries Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return LeasingEventInquiriesPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new LeasingEventInquiriesPeer();
        }
    ...
    public function setLeasingEventPlace(LeasingEventPlace $v = null)
    {
        ...
        if ($v !== null) {
            $v->addLeasingEventInquiries($this);
        }
    ...
    public function getLeasingEventPlace(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aLeasingEventPlace === null && ($this->event_place_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aLeasingEventPlace->addLeasingEventInquiriess($this);
             */
        }
    ...
    public function getLeasingEventLeads(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aLeasingEventLeads === null && ($this->event_leads_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aLeasingEventLeads->addLeasingEventInquiriess($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(LeasingEventInquiriesPeer::DEFAULT_STRING_FORMAT);
    }
