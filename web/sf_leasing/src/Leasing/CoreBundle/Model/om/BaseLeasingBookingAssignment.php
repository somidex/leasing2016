...
abstract class BaseLeasingBookingAssignment extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Leasing\\CoreBundle\\Model\\LeasingBookingAssignmentPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        LeasingBookingAssignmentPeer
     */
     ...
     * @return LeasingBookingAssignment The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = LeasingBookingAssignmentPeer::ID;
        }
    ...
    public function setLeasingSpecialistId($v)
    {
        ...
        if ($this->leasing_specialist_id !== $v) {
            ...
            $this->modifiedColumns[] = LeasingBookingAssignmentPeer::LEASING_SPECIALIST_ID;
        }
    ...
    public function setBookingsId($v)
    {
        ...
        if ($this->bookings_id !== $v) {
            $this->bookings_id = $v;
            $this->modifiedColumns[] = LeasingBookingAssignmentPeer::BOOKINGS_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->bookings_id = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
            $this->resetModified();
            ...
            return $startcol + 3; // 3 = LeasingBookingAssignmentPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating LeasingBookingAssignment object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = LeasingBookingAssignmentPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = LeasingBookingAssignmentQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                LeasingBookingAssignmentPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(LeasingBookingAssignmentPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(LeasingBookingAssignmentPeer::LEASING_SPECIALIST_ID)) {
            $modifiedColumns[':p' . $index++]  = '`leasing_specialist_id`';
        }
        if ($this->isColumnModified(LeasingBookingAssignmentPeer::BOOKINGS_ID)) {
            $modifiedColumns[':p' . $index++]  = '`bookings_id`';
        }

        $sql = sprintf(
            'INSERT INTO `booking_assignment` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = LeasingBookingAssignmentPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = LeasingBookingAssignmentPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['LeasingBookingAssignment'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['LeasingBookingAssignment'][$this->getPrimaryKey()] = true;
        $keys = LeasingBookingAssignmentPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getLeasingSpecialistId(),
            $keys[2] => $this->getBookingsId(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setBookingsId($arr[$keys[2]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LeasingBookingAssignmentPeer::ID)) $criteria->add(LeasingBookingAssignmentPeer::ID, $this->id);
        if ($this->isColumnModified(LeasingBookingAssignmentPeer::LEASING_SPECIALIST_ID)) $criteria->add(LeasingBookingAssignmentPeer::LEASING_SPECIALIST_ID, $this->leasing_specialist_id);
        if ($this->isColumnModified(LeasingBookingAssignmentPeer::BOOKINGS_ID)) $criteria->add(LeasingBookingAssignmentPeer::BOOKINGS_ID, $this->bookings_id);
    ...
    {
        $criteria = new Criteria(LeasingBookingAssignmentPeer::DATABASE_NAME);
        $criteria->add(LeasingBookingAssignmentPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of LeasingBookingAssignment (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return LeasingBookingAssignment Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return LeasingBookingAssignmentPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new LeasingBookingAssignmentPeer();
        }
    ...
    public function setLeasingSpecialist(LeasingSpecialist $v = null)
    {
        ...
        if ($v !== null) {
            $v->addLeasingBookingAssignment($this);
        }
    ...
    public function getLeasingSpecialist(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aLeasingSpecialist === null && ($this->leasing_specialist_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aLeasingSpecialist->addLeasingBookingAssignments($this);
             */
        }
    ...
    public function getLeasingBookings(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aLeasingBookings === null && ($this->bookings_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aLeasingBookings->addLeasingBookingAssignments($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(LeasingBookingAssignmentPeer::DEFAULT_STRING_FORMAT);
    }
