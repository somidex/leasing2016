						...
						<div id="formDetails">
							...
							<div class="row">
								<div class="col-md-6">
									...
									<select name="leasePeriod" id="leasePeriod" class="input-sm form-control">
										<option value="">Select One</option>
								...
								<div class="col-md-6">
									...
									<input type="text" class="input-sm form-control" id="targetMoveIn" name="targetMoveIn" />
								</div>
							</div>
							<div class="row">
							...
							<div class="row">
								<div class="inputHalf col-md-6">
									...
									<select name="firstHeard" id="firstHeard" class="input-sm form-control">
